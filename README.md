...
## Framingham App
The [Framingham App](https://mousavilaleh.github.io/framingham_test/) app will make complex calculations based on your entered data (age, sex, smoking status, treatment for hypertension, total cholesterol, HDL cholesterol and systolic blood pressure) and will give you the result. <br/> This app will not collect data from individuals. <br/>
